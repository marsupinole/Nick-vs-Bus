...
NickVsBus = (function(_super) {
  ...
  NickVsBus.prototype.start = function() {
    ...
    if (this.world.p1.curDir === 'Down') {
      this.world.p1.toggleDirection();
    }
  ...
  */
  ...
  NickVsBus.prototype.draw = function() {
    var i, msg, msgs, offset, sprite, _i, _j, _len, _len1, _ref, _results;
    ...
    */
    ...
    if (this.displayMsg) {
      ...
      if (msgs.length > 0) {
        _results = [];
        for (i = _j = 0, _len1 = msgs.length; _j < _len1; i = ++_j) {
          msg = msgs[i];
          if (i >= 5) {
